...
public class StyleDetailFrame extends JFrame {

	public static StyleDetailFrame styleDetail;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StyleDetailFrame frame = new StyleDetailFrame();
	...
	public static StyleDetailFrame getInstance() {
		if (styleDetail == null) {
			styleDetail = new StyleDetailFrame();
			styleDetail.setExtendedState(JFrame.MAXIMIZED_BOTH); 
			styleDetail.setVisible(true);
			styleDetail.setResizable(false);
			return styleDetail;
		}
		styleDetail.setExtendedState(JFrame.MAXIMIZED_BOTH); 
		styleDetail.setVisible(true);
	...
	public StyleDetailFrame() {
		...
		btnClear.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				removeStyle(txtStyleName.getText());
			}
		});
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Conversation.addConversation("Flag", "Style_Detail");
	...
	public void initializedData() {
		...
		try {
			...
			txtStyleName.setText(style.getStyleName());
			txtImgPath.setText(style.getImagePath());
			txtStyleSize.setText(style.getSize());
			txtRemarks.setText(style.getRemark());
			Date date;
			try {
				date = formatter.parse(style.getStyleProduceDate());
	...
	public void includeItem(Style style) {
		List<StyleInclude> includeList = new ArrayList<StyleInclude>();
		includeList = style.getStyleIncludeList();
		for(StyleInclude si : includeList) {
			dtm.addRow(new Object[]{
					rowCount+1,
					si.getStockInId(),
					si.getStockName(),
	...
	public void editStyle(Style style) {
		try {
			inventoryServiceManager.editStyle(style);
			JOptionPane.showMessageDialog(null, "Style updating successful",
					"Info", JOptionPane.INFORMATION_MESSAGE);
		}
		catch(Exception ex) {
			JOptionPane.showMessageDialog(null, "Fail to update style.",
					"Error Info", JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	public void removeStyle(String styleCode){
		try {
			inventoryServiceManager.removeStyle(styleCode);
			JOptionPane.showMessageDialog(null, "Style deleting successful",
					"Info", JOptionPane.INFORMATION_MESSAGE);
		}
		catch(Exception ex) {
			JOptionPane.showMessageDialog(null, "Fail to delete style.",
					"Error Info", JOptionPane.ERROR_MESSAGE);
		}
	}
