...
public class SearchLineFrame1 extends JFrame {

	public static SearchLineFrame1 searchItemBalanceFrame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SearchLineFrame1 frame = new SearchLineFrame1();
	...
	public static SearchLineFrame1 getInstance() {
		if (searchItemBalanceFrame == null) {
			searchItemBalanceFrame = new SearchLineFrame1();
