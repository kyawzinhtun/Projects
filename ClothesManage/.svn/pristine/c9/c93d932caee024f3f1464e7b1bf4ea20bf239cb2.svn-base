...
class CheckBoxHandler implements MouseListener {
		...
		public void mouseClicked(MouseEvent e) {
			 ...
			 int selectedCol = table.getSelectedColumn();
			  ...
			  if(selectedCol == 0) {
				 showAccessoriesList(dtm.getValueAt(selectedRow, 1)+"");
			 }
		}
...
//			accessories.setVisible(true);
			List<Accessories> accessoriesList=iLineServiceManager.getAccessoriesListById(rowNumber);
			AccessoriesDetailPopUp accessories=new AccessoriesDetailPopUp();
			accessories.setAccessoriesList(accessoriesList);
			accessories.setVisible(true);
		}
