 ...
 */
public class FragmentEightTeen extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String fragmentEighTeenString = getResources().getString(R.string.fragment_eighteen_string);
        tv.setText(fragmentEighTeenString);
