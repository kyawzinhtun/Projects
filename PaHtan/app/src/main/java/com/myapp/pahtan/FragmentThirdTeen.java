 ...
 */
public class FragmentThirdTeen extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String fragmentThirdTeenString = getResources().getString(R.string.fragment_thirdtenn_string);
        tv.setText(fragmentThirdTeenString);
