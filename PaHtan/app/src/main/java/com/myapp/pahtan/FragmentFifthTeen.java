 ...
 */
public class FragmentFifthTeen extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String fragmentFifthTeenString = getResources().getString(R.string.fragment_fifthteen_string);
        tv.setText(fragmentFifthTeenString);
